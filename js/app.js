...
if (document.querySelector('.products-slider')) {
   let ProductsSlider = new Swiper('.products-slider__item', {
      ...
      navigation: {
         ...
         prevEl: '.products-slider__arrow_prew',
      },
      /*
      breakpoints: {
         320: {
...
let iconPhone = document.querySelector(".header-numbers__icon");
if (iconPhone != null) {
   let phoneBody = document.querySelector(".header-numbers");
...
function menu_close() {
   let iconPhone = document.querySelector(".header-numbers__icon");
   let phoneBody = document.querySelector(".header-numbers");
   iconPhone.classList.remove("_active");
...
if (menuPageBurger != null) {
   let menuPageList = document.querySelector(".menu-page__list");
   menuPageBurger.addEventListener("click", function (e) {
      if (unlock) {
         menuPageBurger.classList.toggle("_active");
         _slideToggle(menuPageList);
      }
   });
};
